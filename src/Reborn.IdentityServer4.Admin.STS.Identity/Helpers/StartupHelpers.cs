...
using Reborn.IdentityServer4.Admin.STS.Identity.Configuration.ApplicationParts;
using Reborn.IdentityServer4.Admin.STS.Identity.Helpers.Localization;

namespace Reborn.IdentityServer4.Admin.STS.Identity.Helpers;
