...
(function() {
    ...
    var QRCodeLimitLength = [
        ...
        [154, 122, 86, 64], [192, 152, 108, 84], [230, 180, 130, 98], [271, 213, 151, 119], [321, 251, 177, 137],
        [367, 287, 203, 155], [425, 331, 241, 177], [458, 362, 258, 194], [520, 412, 292, 220], [586, 450, 322, 250],
        [644, 504, 364, 280], [718, 560, 394, 310], [792, 624, 442, 338], [858, 666, 482, 382], [929, 711, 509, 403],
    ...
    var svgDrawer = (function() {
        ...
        Drawing.prototype.draw = function(oQRCode) {
            ...
            svg.appendChild(makeSVG("rect",
                { "fill": _htOption.colorDark, "width": "1", "height": "1", "id": "template" }));
        ...
        ? (function() {
            ...
            Drawing.prototype.draw = function(oQRCode) {
                ...
                for (let row = 0; row < nCount; row++) {
                    ...
                    for (let col = 0; col < nCount; col++) {
                        aHTML.push(
                            `<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:${nWidth}px;height:${
                            nHeight}px;background-color:${oQRCode.isDark(row, col)
                            ? _htOption.colorDark
    ...
    QRCode.prototype.makeCode = function(sText) {
        this._oQRCode =
            new QRCodeModel(_getTypeNumber(sText, this._htOption.correctLevel), this._htOption.correctLevel);
